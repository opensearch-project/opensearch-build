void call(Map args = [:]) {
    ...
    String artifactRootUrl = buildManifest.getArtifactRootUrl("${PUBLIC_ARTIFACT_URL}", "${JOB_NAME}", "${BUILD_NUMBER}")
    ...
    echo "Setting env.\"ARTIFACT_ROOT_URL_${buildManifest.build.platform}_${buildManifest.build.architecture}\"=${artifactRootUrl}"
    env."ARTIFACT_ROOT_URL_${buildManifest.build.platform}_${buildManifest.build.architecture}" = artifactRootUrl
}
