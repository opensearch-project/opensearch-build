...
|[bwc-test](https://build.ci.opensearch.org/job/bwc-test/)<br><br>[bwc-test-opensearch-dashboards](https://build.ci.opensearch.org/job/bwc-test-opensearch-dashboards/)	|30-60min	|S3<br>EC2<br>&nbsp;&nbsp;&nbsp;&nbsp;c54xlarge<br>&nbsp;&nbsp;&nbsp;&nbsp;c6g4xlarge<br>CloudFront	|Product Core Repositories (GitHub)<br><br>Individual Component Repositories (GitHub)	|
|[integ-test](https://build.ci.opensearch.org/job/integ-test/)<br><br>[integ-test-opensearch-dashboards](https://build.ci.opensearch.org/job/integ-test-opensearch-dashboards/)	|60-100min	|S3<br>EC2<br>&nbsp;&nbsp;&nbsp;&nbsp;c54xlarge<br>&nbsp;&nbsp;&nbsp;&nbsp;c6g4xlarge<br>CloudFront	|Individual Component Repositories  (GitHub)<br><br>[opensearch-dashboards-functional-test](https://github.com/opensearch-project/opensearch-dashboards-functional-test) (GitHub)	|
