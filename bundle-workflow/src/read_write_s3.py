...
class read_write_files:
    ...
    def __init__(self, RoleArn, RoleSessionName):
        self.RoleArn = RoleArn
        self.RoleSessionName = RoleSessionName

    def get_S3Objects(self, bucketname, bucket_bundle, bucket_manifest, path_tosave_Bundle, path_tosave_Manifest):
    ...
    def put_S3Objects(self, bucketname, filename, filePath):
        sts_connection = boto3.client('sts')
        acct_b = sts_connection.assume_role(
            RoleArn=self.RoleArn,
            RoleSessionName=self.RoleSessionName,
