...
def main():
    ...
    parser.add_argument("--workload", default="nyc_taxis", help="Mensor param - Workload name from OpenSeach Benchmark Workloads")
    parser.add_argument("--workload-options", default="{}", help="Mensor param - Json object with OpenSearch Benchmark arguments")
    parser.add_argument("--warmup-iters", default=0, help="Mensor param - Number of times to run a workload before collecting data")
    parser.add_argument("--test-iters", default=1, help="Mensor param - Number of times to run a workload")
