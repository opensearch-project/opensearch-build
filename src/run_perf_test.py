...
def main():
    ...
    parser.add_argument("--workload", default="nyc_taxis", help="The name of the workload from OpenSeach Benchmark Workloads")
    parser.add_argument("--workload-options", default="{}", help="Json object with workload options to supply to OpenSearch Benchmark")
    parser.add_argument("--warmup-iters", default=0, help="Number of warmup iterations for a workload before collecting data")
    parser.add_argument("--test-iters", default=1, help="Number of test iterations for a workload")
