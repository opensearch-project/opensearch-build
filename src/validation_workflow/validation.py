...
class Validation(ABC):
    ...
    def install_native_plugin(self, path: str, installed_plugins_list: list) -> None:
        ...
        if self.args.artifact_type == "staging":
            self.download_and_install_native_plugin_zip(native_plugins_list, os.path.join(path, "bin"))
        else:
            try:
    ...
    def download_and_install_native_plugin_zip(self, native_plugins_list: list, download_path: str) -> None:
        for native_plugin in native_plugins_list:
