...
class TestInputManifests(unittest.TestCase):
    ...
    def test_files_opensearch(self) -> None:
        ...
        self.assertTrue(os.path.join(InputManifests.manifests_path(), os.path.join("3.8.0", "opensearch-3.8.0.yml")) in files)
    ...
    def test_files_opensearch_dashboards(self) -> None:
        ...
        self.assertTrue(os.path.join(InputManifests.manifests_path(), os.path.join("3.8.0", "opensearch-dashboards-3.8.0.yml")) in files)
