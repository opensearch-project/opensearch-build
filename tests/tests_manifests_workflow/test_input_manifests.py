...
class TestInputManifests(unittest.TestCase):
    ...
    def test_files_opensearch(self) -> None:
        ...
        self.assertTrue(os.path.join(InputManifests.manifests_path(), os.path.join("3.5.0", "opensearch-3.5.0.yml")) in files)
    ...
    def test_files_opensearch_dashboards(self) -> None:
        ...
        self.assertTrue(os.path.join(InputManifests.manifests_path(), os.path.join("3.5.0", "opensearch-dashboards-3.5.0.yml")) in files)
    ...
    def test_create_manifest_opensearch_dashboards_default_template(self) -> None:
        ...
        self.assertEqual(
            input_manifest[1].to_dict(),
            {
                "schema-version": "1.1",
                "name": "OpenSearch Dashboards",
                "ci": {"image": {"linux": {"tar": {"name": "opensearchstaging/ci-runner-almalinux8-opensearch-dashboards-integtest-v2",
