...
class TestDistributions(unittest.TestCase):
    ...
    def test_distribution_map(self) -> None:
        ...
        self.assertEqual(self.distributions.DISTRIBUTIONS_MAP['deb'].__name__, 'DistributionDeb')
    ...
    def test_create_dist(self) -> None:
        ...
        return_cls_deb = self.distributions.get_distribution("opensearch", "deb", "1.3.0", os.path.join(os.path.dirname(__file__), "data"))
        self.assertEqual(return_cls_deb.__class__.__name__, 'DistributionDeb')
