...
class TestBenchmarkTestSuite(unittest.TestCase):
    ...
    def test_execute_default(self, mock_check_call: Mock) -> None:
        ...
        with patch('test_workflow.benchmark_test.benchmark_test_suite.TemporaryDirectory') as mock_temp_directory:
            ...
            self.assertEqual(test_suite.command, f'docker run --name docker-container-{test_suite.args.stack_suffix} opensearchproject/opensearch-benchmark:latest execute-test '
    ...
    def test_convert(self, mock_get_terminal_size: Mock, mock_logging_info: Mock, mock_open: Mock, mock_json_load: Mock, mock_read_csv: Mock,
