...
class TestBenchmarkTestSuite(unittest.TestCase):
    def setUp(self, config=None, tag=None) -> None:
        self.args = Mock()
        self.args.workload = "nyc_taxis"
        self.args.benchmarkConfig = config
        self.args.userTag = tag
    ...
    def test_execute_default(self) -> None:
        with patch("subprocess.check_call") as mock_check_call:
            ...
            self.assertEqual(self.benchmark_test_suite.command,
                             'docker run opensearch-benchmark:latest execute_test --workload=nyc_taxis --test-mode '
    ...
    def test_execute_security_enabled(self) -> None:
        ...
        with patch("subprocess.check_call") as mock_check_call:
            ...
            self.assertEqual(benchmark_test_suite.command, 'docker run opensearch-benchmark:latest execute_test '
    ...
    def test_execute_default_with_optional_args(self) -> None:
        ...
        with patch("subprocess.check_call") as mock_check_call:
            ...
            self.assertEqual(self.benchmark_test_suite.command, 'docker run -v /home/test/benchmark.ini:'
                                                                ...
                                                                'opensearch-benchmark:latest execute_test '
