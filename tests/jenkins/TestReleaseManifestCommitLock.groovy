...
class TestReleaseManifestCommitLock extends BuildPipelineTest {
    ...
    public void testManifestCommitLock_matchBuildManifest() {
        ...
        super.testPipeline('jenkins/release-workflows/release-manifest-commit-lock-lf.jenkinsfile',
    ...
    public void testManifestCommitLock_matchBuildManifest_exception() {
        ...
        runScript('jenkins/release-workflows/release-manifest-commit-lock-lf.jenkinsfile')
        }
        def callStack = helper.getCallStack()
    ...
    public void testManifestCommitLock_updateToTags() {
        ...
        assertCallStack().contains('release-manifest-commit-lock-lf.writeYaml({file=manifests/2.0.0/opensearch-2.0.0.yml, data={schema-version=1.0, build={name=OpenSearch, version=2.0.0, qualifier=alpha1}, ci={image={name=opensearchstaging/ci-runner:ci-runner-centos7-opensearch-build-v2, args=-e JAVA_HOME=/opt/java/openjdk-17}}, components=[{name=OpenSearch, ref=tags/2.0.0, repository=https://github.com/opensearch-project/OpenSearch.git, checks=[gradle:publish, gradle:properties:version]}, {name=common-utils, repository=https://github.com/opensearch-project/common-utils.git, ref=2.0, checks=[gradle:publish, gradle:properties:version]}, {name=job-scheduler, repository=https://github.com/opensearch-project/job-scheduler.git, ref=2.0, checks=[gradle:properties:version, gradle:dependencies:opensearch.version]}]}, overwrite=true})')
    }
    ...
    public void testUpdateToRecentCommit() {
        ...
        assertCallStack().contains('release-manifest-commit-lock-lf.readYaml({file=manifests/2.0.0/opensearch-dashboards-2.0.0.yml})')
        assertCallStack().contains('release-manifest-commit-lock-lf.readYaml({file=manifests/2.0.0/opensearch-dashboards-2.0.0.yml})')
        assertCallStack().contains('release-manifest-commit-lock-lf.sh({script=git ls-remote https://github.com/opensearch-project/OpenSearch.git 2.0 | cut -f 1, returnStdout=true})')
        assertCallStack().contains("release-manifest-commit-lock-lf.writeYaml({file=manifests/2.0.0/opensearch-2.0.0.yml")
    ...
    public void testUpdateToReleaseBranch() {
        ...
        assertCallStack().contains("release-manifest-commit-lock-lf.readYaml({file=manifests/2.0.0/opensearch-2.0.0.yml})")
        assertCallStack().contains("release-manifest-commit-lock-lf.echo(Skipping stage MATCH_BUILD_MANIFEST)")
        assertCallStack().contains("release-manifest-commit-lock-lf.echo(Skipping stage UPDATE_TO_RECENT_COMMITS)")
        assertCallStack().contains("release-manifest-commit-lock-lf.echo(Skipping stage UPDATE_TO_TAGS)")
    }
    ...
    public void test_excludeFTRepo() {
        ...
        assertCallStack().contains("release-manifest-commit-lock-lf.writeYaml({file=manifests/2.0.0/opensearch-dashboards-2.0.0.yml, data={ci={image={name=opensearchstaging/ci-runner:centos7-x64-arm64-jdkmulti-node10.24.1-cypress6.9.1-20211028}}, build={name=OpenSearch Dashboards, version=3.0.0}, components=[{name=OpenSearch-Dashboards, ref=tags/3.0.0, repository=https://github.com/opensearch-project/OpenSearch-Dashboards.git}, {name=functionalTestDashboards, repository=https://github.com/opensearch-project/opensearch-dashboards-functional-test.git, ref=3.0}, {name=observabilityDashboards, ref=tags/3.0.0, repository=https://github.com/opensearch-project/dashboards-observability.git}, {name=indexManagementDashboards, ref=tags/3.0.0, repository=https://github.com/opensearch-project/index-management-dashboards-plugin}, {name=ganttChartDashboards, ref=tags/3.0.0, repository=https://github.com/opensearch-project/dashboards-visualizations.git}, {name=reportsDashboards, ref=tags/3.0.0, repository=https://github.com/opensearch-project/dashboards-reports.git}, {name=queryWorkbenchDashboards, ref=tags/3.0.0, repository=https://github.com/opensearch-project/sql.git}, {name=anomalyDetectionDashboards, ref=tags/3.0.0, repository=https://github.com/opensearch-project/anomaly-detection-dashboards-plugin}], schema-version=1.0}, overwrite=true})")
    }
