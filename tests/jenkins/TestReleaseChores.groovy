...
class TestReleaseChores extends BuildPipelineTest {
    ...
    public void testParameterSetUp() {
        addParam('RELEASE_VERSION', '3.8.0')
    ...
    public void testStageToLibMappingCheckReleaseOwners() {
        ...
        assertCallStack().contains('release-chores.checkRequestAssignReleaseOwners({inputManifest=[manifests/3.8.0/opensearch-3.8.0.yml, manifests/3.8.0/opensearch-dashboards-3.8.0.yml], action=check})')
    }
    ...
    public void testStageToLibMappingCheckDocumentation() {
        ...
        assertCallStack().contains('release-chores.checkDocumentationIssues({version=3.8.0, action=check})')
    }
    ...
    public void testStageToLibMappingCheckCodeCoverage() {
        ...
        assertCallStack().contains('release-chores.checkCodeCoverage({inputManifest=[manifests/3.8.0/opensearch-3.8.0.yml, manifests/3.8.0/opensearch-dashboards-3.8.0.yml], action=check})')
    }
    ...
    public void testStageToLibMappingCheckReleaseNotes() {
        ...
        def callStack = helper.getCallStack()
        assertThat(getCommandExecutions('sh', 'release_notes.sh'), hasItem(containsString('./release_notes.sh check manifests/3.8.0/opensearch-3.8.0.yml manifests/3.8.0/opensearch-dashboards-3.8.0.yml --date 2025-03-19 --output /tmp/workspace/table.md')))
        assertCallStack().contains('release-chores.stage(checkReleaseNotes, groovy.lang.Closure)')
        assertCallStack().contains('release-chores.checkReleaseNotes({version=3.8.0, dataTable=/tmp/workspace/table.md, action=check})')
    }
    ...
    public void testStageToLibMappingCheckReleaseIssues() {
        ...
        assertCallStack().contains('release-chores.checkReleaseIssues({version=3.8.0, inputManifest=[manifests/3.8.0/opensearch-3.8.0.yml, manifests/3.8.0/opensearch-dashboards-3.8.0.yml], action=check})')
    }
    ...
    public void testStageToLibMappingCheckDocumentationPullRequests() {
        ...
        assertCallStack().contains('release-chores.checkDocumentationPullRequests({version=3.8.0})')
    }
