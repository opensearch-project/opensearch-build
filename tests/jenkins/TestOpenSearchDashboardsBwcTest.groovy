...
class TestOpenSearchDashboardsBwcTest extends BuildPipelineTest {
    ...
    void bwcTests_runs_consistently() {
        super.testPipeline('jenkins/opensearch-dashboards/bwc-test.jenkinsfile',
                'tests/jenkins/jenkinsjob-regression-files/opensearch-dashboards/bwc-test.jenkinsfile')
    }
}
