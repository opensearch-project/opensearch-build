...
class TestReleaseNotes(unittest.TestCase):
    ...
    def test_check(self, *mocks: Any) -> None:
        self.assertEqual(self.release_notes.check(self.component), ['OpenSearch-test', '[ref]', None, None, False, None])
    ...
    def test_check_with_manifest(self, *mocks: Any) -> None:
        ...
        if type(component) is InputComponentFromSource:
            ...
            self.assertEqual(self.release_notes.check(component), ['OpenSearch-test', '[main]', None, None, False])

    @patch('release_notes_workflow.release_notes.ReleaseNotes.check', return_value=['OpenSearch-test', '[main]', 'ee26e01', '2022-08-18', False])
    def test_table(self, *mocks: Any) -> None:
        ...
        self.assertEqual(table_output.value_matrix, [['OpenSearch-test', '[main]', 'ee26e01', '2022-08-18', False]])
